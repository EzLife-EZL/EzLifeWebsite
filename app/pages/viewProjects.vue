    ...
    <div class="container">
        <div class="stats-grid">
            ...
            <div class="stat-card card-3">
                <div class="icon">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M9 11H7v9a2 2 0 002 2h6a2 2 0 002-2v-9h-2m1-4V6a2 2 0 00-2-2h-4a2 2 0 00-2 2v1M7 7h10"/>
                    </svg>
                </div>
                <div class="content">
                    <h3>500+</h3>
                    <p>Đội tác SEO<br>luôn đồng hành</p>
                </div>
            </div>
            ...
            <div class="stat-card card-5">
                ...
                <div class="content">
                    <h3>50+</h3>
                    <p>Dự án media<br>triển khai thành công</p>
                </div>
            </div>
            ...
            <div class="stat-card card-6">
                ...
                <div class="content">
                    <h3>250+</h3>
                    <p>Dự án Elearning<br>ấn tượng</p>
                </div>
            </div>
        </div>
